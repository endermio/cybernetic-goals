...
- structure/external-contract semantics
...
Level 2:
- Fix a misleading observer display inside an already analyzed control structure.
- Update an evidence assertion after a confirmed observer-label change.
- Adjust fixture names so local preview matches existing requirement semantics.
...
- Execute new multi-subsystem work without approved control artifacts.
