...
description: 'Use when a cybernetic skill must choose required Superpowers workflow for planning, independent review, runtime execution, debugging, or completion verification.'
---
...
Cybernetic skills compile approved work chains. Superpowers skills provide the behavior workflow for planning, independent review discipline, execution, debugging, and completion verification.
...
- invoke the workflow, or load and follow its `SKILL.md` instructions when direct invocation is unavailable;
