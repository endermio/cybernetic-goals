...
- identify the approved answering method for tasks where merely running a plausible path would not answer the question, including the not-sufficient substitute and task skeleton family;
