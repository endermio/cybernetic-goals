...
For Level 1/2 work with `rubric check: required`, summarize the confirmed rubric and output the bounded goal-writing handoff described in `Queue-Friendly Next Commands`.
